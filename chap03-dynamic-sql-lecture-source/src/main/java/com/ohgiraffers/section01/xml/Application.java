...
public class Application {
    ...
    /* 설명. 1부터 21까지의 5개의 중복되지 않는 번호 생성해 List 에 쌓아 반환하는 메소드 */
    ...
    /* 설명. SearchCriteria(condition 과 value 의 묶음) 개념을 이번에는 DTO가 아닌 Map으로 작성해보자. */
    ...
    private static SearchCriteria inputAllOrOne() {
        ...
        boolean hasSuchValue = "예".equals(sc.nextLine()) ? true : false;
